...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetrica_FMDB/AppMetrica_FMDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetrica_Protobuf/AppMetrica_Protobuf.framework"
